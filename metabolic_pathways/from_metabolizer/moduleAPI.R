...
# midas_home <-  "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/tools/metabolizer/"
# species <- "hsa"
# exp_file <- "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/users/demo/brca_example1_40__exp.txt"
# design_file  <- "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/users/demo/brca_example1_40__design.txt"
# cond1 <- "Normal"
# cond2 <- "Tumor"
# output_folder <- "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/tools/metabolizer/to_delete/"
# #analysis <- "compare" #compare(ModuleActivity), pathact(InsilicoKO), train ot test(Prediction)
# design_type <- "continuous" #"categorical", "continuous", "mutation_effect"
# paired <- T  # T or F
...
#  midas_home <-  "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/tools/metabolizer/"
#  species <- "hsa"
#  exp_file <- "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/tools/metabolizer/to_delete/LEO/Primary_Tumor_All_Datasets_COMBAT_Quantile.txt"
#  design_file  <- "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/tools/metabolizer/to_delete/LEO/BRCA1_Gene_Expression_Combat.txt"
#  output_folder <- "/httpd/bioinfo/stevia-server/1.0.0_p9901_home/tools/metabolizer/to_delete/LEO/"
#  corvar <-  "BRCA1.expression"
#  design_type <- "continuous"
#  methodcor <- "pearson"

midas_home <- paste0(dirname(normalizePath(args[["file"]])),"/")
species <- args[['species']]
exp_file <- args[['exp_file']]
design_file <- args[['design_file']]
output_folder <- args[['output_folder']] #"/home/cankut/Desktop/cankut-test3/metabolicpaths/"
cond1 <- args[['cond1']]
cond2 <- args[['cond2']]

design_type <- args[['design_type']] #"categorical", "continuous", "mutation_effect"
paired <- args[["paired"]] # T or F
methodcor <- args[["methodcor"]]
corvar <- args[['corvar']]
...
source(paste0(midas_home,"/pretty_functions_Sep2016.R"))
...
load(paste0(midas_home,"/files/midasspecies/",species,"/",species,"_module_data_Dec2016.RData"))
