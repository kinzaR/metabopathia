...
# options(warn=-1)
# # load pathways
# data from usrine has 3 metabolite in tese pathways
# - These metabolite:  C00042 C00186  were found in  hsa04024
# - These metabolite:  C00158 were found in  hsa04742
# pathways_list <- c(pathways_list, "hsa04024","hsa04742")
...
exp <- exp[,sel_samples]
metabo_data <- metabo_data[,sel_samples]
des <- des[sel_samples,]
...
# Perform comparisons
DAdata <- DAcomp(metdata, des$group, cond1, cond2, paired = paired, path.method = "limma", fun.method = "limma")
